...
void BuildMapMenu()
{
	...
	for (int i = 0; i < g_MapList.Length; i++)
	{
		...
		{
			LogError("Error 404: Map %s was found in database but not on mapcycle/maps folder! Please delete entry in database or add the map to server mapcycle/maps folder!", map);
			continue;
		}
